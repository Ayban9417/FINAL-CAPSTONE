...
const controllers = require('../controllers/serialMonitor');
...
router.get('/panel', requireAuth, controller.getPanel);
router.get('/start', requireAuth, controller.getStart);
router.get('/end', requireAuth, controller.getEnd);
...
//router.get('/addStaff', requireAuth, controller.getData);
